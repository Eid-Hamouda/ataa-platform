    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed">
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm">
          ...
          <p className="text-sm md:text-base text-slate-600">
            جميع محتويات منصة عطاء من تصميمات، شعارات، برمجيات، ونصوص هي ملكية حصرية للمنصة. يُحظر استخدام المنصة لأي غايات تجارية أو غير قانونية، وتلتزم الأطراف كافة بحسن النية وسلوك الاحترام المتبادل.
          </p>
        </div>
      </div>
    </div>
