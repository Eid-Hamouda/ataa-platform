    ...
    <div className="container mx-auto px-4 py-16 max-w-5xl">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <p className="text-slate-600 text-lg leading-relaxed">
          منصة "عطاء" هي مبادرة تقنية رائدة تهدف إلى سد الفجوة بين فائض الموارد لدى الأفراد والجهات، واحتياجات الأسر والأفراد المتعففة، محققةً أعلى معايير الشفافية والأثر المستدام.
        </p>
      </div>
